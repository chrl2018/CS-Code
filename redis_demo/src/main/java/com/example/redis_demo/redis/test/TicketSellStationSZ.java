...
/**
 * @author chenruilong
 * @description  模拟不同进程进行售票  可抽象理解为多地售票：苏州售票点
 * @ date 2019-11-12 14:55
 **/

public class TicketSellStationSZ{
    //模拟多个窗口 进行售票
    ...
    //车站名称
    private static final String stationName = "苏州北站";

    private static Logger logger = LoggerFactory.getLogger(TicketSellStationSZ.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            logger.info("苏州北站售票总耗时:" + watch.getTotalTimeSeconds() + "秒");
        }
    }
}
