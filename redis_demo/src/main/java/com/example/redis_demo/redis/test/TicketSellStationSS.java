...
/**
 * @author chenruilong
 * @description  模拟不同进程进行售票  可抽象理解为多地售票：上海售票点
 * @ date 2019-11-12 14:55
 **/

public class TicketSellStationSS{
    ...
    //车站名称
    private static final String stationName = "上海虹桥";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            logger.info("上海虹桥售票总耗时:" + watch.getTotalTimeSeconds() + "秒");
        }
    }
